...
#
# Примечание: чтобы вернуть True, напишите "return True";
...
def check_user(username, password):
    if username in user_database:
        ...
        return False
print(check_user(username = 'user', password = 'password')) # True
print(check_user(username = 'user1', password = 'password1')) # False