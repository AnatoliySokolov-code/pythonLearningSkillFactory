text = "The Zen of PythonBeautiful is better than ugly." \
       ...
       "now.If the implementation is hard to explain, it's a bad idea." \
...
# Количество уникальных символов:  44  правильный ответ